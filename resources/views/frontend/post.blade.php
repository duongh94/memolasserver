...
@section('content')
    <section class="container">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 blog-detail">
                <div class="header">
                    <h3>
                        {{ $post->title }}
                    </h3>
                            ...
                            <div class="share-button">
                                <div class="share-button__back">
                                    ...
                                    <a class="share__link " href="#" title="twitter">
                                        <svg class="share__icon share__icon--twitter" version="1.1"
                                             xmlns="http://www.w3.org/2000/svg"
                                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="49.652px"
                                             height="49.652px" viewBox="0 0 49.652 49.652"
                                             style="enable-background:new 0 0 49.652 49.652;" xml:space="preserve">
                                    ...
                                    <a class="share__link" href="#" title="google plus">
                                        <svg class="share__icon share__icon--google" version="1.1"
                                             xmlns="http://www.w3.org/2000/svg"
                                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="49.652px"
                                             height="49.652px" viewBox="0 0 49.652 49.652"
                                             style="enable-background:new 0 0 49.652 49.652;" xml:space="preserve">
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 slidebar-blogdetail">
                <div style="padding: 15px 15px" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <input id="name-blog" type="text" placeholder="Enter your name...">
                    <input id="email-blog" type="text" placeholder="Email...">
                    <textarea id="content-blog" name="" id="" cols="30" rows="5" placeholder="Message..."></textarea>
                    <input type="submit" id="form-blog" value="Connect with we"/>
                    <p>I will get a notification in a few hours</p>
                </div>
            </div>
...
@section('js')
    ...
    <script src="{{ secure_asset('js/frontend/social.js')}}"></script>
@endsection
