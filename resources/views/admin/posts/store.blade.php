    ...
    <section class="breadcrumbs">
        ...
        <form id="post-form" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Vui lòng nhập tiêu đề bài viết" required value="{{ old('title') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea id="content" name="content" type="text" class="form-control" placeholder="Vui lòng nhập nội dung bài viết" required></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Tiêu đề SEO</label>
                <div class="col-sm-9">
                    <input name="title_seo" type="text" class="form-control" id="title" placeholder="Vui lòng nhập tiêu đề SEO" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Nội dung SEO</label>
                <div class="col-sm-9">
                    <input name="content_seo" class="form-control" id="title" placeholder="Vui lòng nhập nôi dung SEO" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Ảnh đại diện bài viết</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="title" placeholder="Tên ảnh đại diện" readonly>
                </div>
                <div class="col-sm-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 float-right">
                    <img id="image-preview" src="" alt="" hidden class="w-25 img-thumbnail">
                </div>
            </div>
            <div class="form-group row d-flex justify-content-end">
                <div class="col-sm-2"><button id="btn-create" type="button" class="btn btn-success w-100 rounded">Tạo bài viết</button></div>
